        ...
        <div className="w-full md:w-1/4">
          <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24 h-full">
            ...
            <nav className="space-y-1">
              <Link 
                href="/account" 
                className="block px-4 py-2 rounded-md hover:bg-gray-50 flex items-center"
              >
              ...
              <Link 
                href="/account/orders" 
                className="block px-4 py-2 rounded-md hover:bg-gray-50 flex items-center justify-between"
              >
                ...
                {pendingOrders > 0 && (
                  <span className="bg-accent text-sm px-2 py-0.5 rounded-full">
                    {pendingOrders}
                  </span>
                )}
              </Link>
            ...
            <div className="mt-6 pt-6 border-t">
              <button
                ...
                className="w-full px-4 py-2 text-gray-700 hover:text-red-600 transition-colors rounded-md flex items-center"
              >
